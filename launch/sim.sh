...
export GAZEBO_RESOURCE_PATH=$GAZEBO_RESOURCE_PATH:~/han_ws/src/ahpf_planner/gazebo
export GAZEBO_MODEL_PATH=$GAZEBO_MODEL_PATH:~/han_ws/src/ahpf_planner/gazebo/models
