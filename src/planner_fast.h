...
//         MatrixXd waypoints;    // pva * time
        ...
        void replan_traj(double MAXVEL,Vector3d &start,Vector3d &vi,Vector3d &ai,MatrixXd &waypoints,MatrixXd &cd_c,VectorXd &cd_r,vec_Vec3f *obs_pointer, dynobs_tmp *dynobs, double plan_t, bool full_trip = true);
