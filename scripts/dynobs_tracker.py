...
#                                      self.callback,queue_size=1,buff_size=52428800) #/filtered_RadiusOutlierRemoval',
        ...
        self.tss = ApproximateTimeSynchronizer([
                                                Subscriber('/filtered_RadiusOutlierRemoval',PointCloud2),   # the point cloud input
                                                # Subscriber('/gt_iris_base_link_imu', Odometry),
                                                Subscriber('/mavros/local_position/pose', PoseStamped),     #vehicle position input
                                                Subscriber('/mavros/local_position/velocity_local',TwistStamped)],  #vehicle velocity input (for time alignment and translate the point cloud from B-xyz to E-XYZ more precisely)
